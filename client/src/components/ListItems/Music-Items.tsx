...
export default function MusicItems({ title, artist, song, id, onClick }: MusicItemsProps): JSX.Element {
  ...
  return (
    <div className="flex flex-row justify-left px-5 py-2 my-2 bottom-2 bg-blue-200" onClick={() => selectedMusic(song)}>
      <Image
